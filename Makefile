...
export F90COMP := $(F90FLAGS_DEBUG) -I$(TOPDIR)/src/f90/include $(HEALPIX_INCLUDE) $(LAPACK_INCLUDE) $(CFITSIO_INCLUDE) $(FFTW_INCLUDE) $(HDF_INCLUDE)
...
all : libquiet libutil l2gen l3gen postmap map_editor maptool scan_validate tod2map scan_detect # test ces_detect utils_f90
